...
class solopine_latest_news_widget extends WP_Widget {
	...
	function solopine_latest_news_widget() {
		...
		/* Create the widget. */
		parent::__construct( 'solopine_latest_news_widget', __('Hemlock: Latest Posts', 'solopine_latest_news_widget'), $widget_ops, $control_ops );
	}
				...
				<li>
					...
					<div class="side-item">
						...
						<div class="side-image">
							<a href="<?php echo get_permalink() ?>" rel="bookmark" title="Permanent Link: <?php the_title(); ?>"><?php the_post_thumbnail('thumb', array('class' => 'side-item-thumb')); ?></a>
						</div>
						<?php endif; ?>
