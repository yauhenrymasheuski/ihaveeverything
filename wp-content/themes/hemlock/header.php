	...
	<nav id="navigation">
		...
		<div class="container">
			...
			<div id="top-social">
				...
				<?php if(get_theme_mod('sp_snapchat')) : ?><a href="https://snapchat.com/add/<?php echo get_theme_mod('sp_snapchat'); ?>" target="_blank"><i class="fa fa-snapchat-ghost"></i></a><?php endif; ?>
